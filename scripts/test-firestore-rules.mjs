...
const CASES = [
  ...
  testCase("post with neither text nor image is denied", "DENY", { uid: "alice", path: "/communityPosts/p1", method: "create", data: post({ content: "" }) }),
  testCase("image-only post (no caption) is allowed", "ALLOW", { uid: "alice", path: "/communityPosts/p1", method: "create", data: post({ content: "", imageUrl: "https://example.com/i.jpg" }) }),
  testCase("empty caption with empty imageUrl is denied", "DENY", { uid: "alice", path: "/communityPosts/p1", method: "create", data: post({ content: "", imageUrl: "" }) }),
  testCase("caption plus image is allowed", "ALLOW", { uid: "alice", path: "/communityPosts/p1", method: "create", data: post({ content: "look", imageUrl: "https://example.com/i.jpg" }) }),
